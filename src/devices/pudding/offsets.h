...
OFFSETS_ENTRY("6.12.23-android16-5-gb23e74f69076-abogki452159376-4k",  /* OS3.0.313.0.WPCCNXM (abogki452159376) */
  .kernel_phys_load=0xc7800000, STRUCT_OFFSETS_6_12,
  .off_init_task=0x023FCF00, .off_init_cred=0x02412A68, .off_init_uts_ns=0x02586A90,
  .off_empty_zero_page=0x02626000, .off_root_task_group=0x0262E580,
  .off_selinux_enforcing=0x0267A5B8, .off_kptr_restrict=0x023FB638,
  .off_selinux_blob_sizes=0x018404E8, .off_security_hook_heads=0,
  .off_kmalloc_caches=0x0183A4C0, .off_anon_pipe_buf_ops=0x0121EE08,
  .off_ashmem_misc_fops=0, .off_ashmem_fops=0x013A4EC8,
  .off_ashmem_ioctl=0x00D8537C, .off_ashmem_compat_ioctl=0x00D85964,
  .off_ashmem_mmap=0x00D859E0, .off_ashmem_open=0x00D85A3C,
  .off_ashmem_release=0x00D8543C, .off_ashmem_show_fdinfo=0x00D8593C,
  .off_configfs_read_iter=0x00512140, .off_configfs_bin_write_iter=0x005126EC,
  .off_copy_splice_read=0x0048E8A8, .off_noop_llseek=0x0043BEEC,
  .off_cap_capable_active=0x02674C18,
  .off_slide_nfulnl_logger=0x023F21B0, .off_slide_loggers_0_1=0x023F20F8,
  .off_slide_boot_id=0x0269B968,
  .off_system_unbound_wq=0x0183A250, .off_call_usermodehelper_exec_work=0x000F6744,
),
